...
namespace Student.Management.System.Infrastructure.Migrations
{
    ...
    [Migration("20230111084314_FixedForeignKeyConstraint")]
    partial class FixedForeignKeyConstraint
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Student.Management.System.Domain.Entities.Stud", b =>
                {
                    ...
                    b.Property<int?>("FavouriteSubjectSubjectId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FavouriteSubjectSubjectId");
            ...
            modelBuilder.Entity("Student.Management.System.Domain.Entities.Stud", b =>
                {
                    b.HasOne("Student.Management.System.Domain.Entities.Subject", "FavouriteSubject")
                        .WithMany("Students")
                        .HasForeignKey("FavouriteSubjectSubjectId");
